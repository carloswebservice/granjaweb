						...
						<div class="panel-body">
							<form class="form-horizontal" id="form_raza"> <br>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" onkeypress="return solo_letras(event)" name="raz_descripcion" id="raz_descripcion" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
									...
									<div class="col-sm-9">
										<input type="text" onkeypress="return solo_letras(event)" name="raz_abreviatura" id="raz_abreviatura" class="form-control">
									</div>
								</div> <br>
