	...
	<div class="row">
		<div class="col-sm-12">
			<div class="breadcrumb">
				...
				<center><h4>
					<i class="fa fa-file-text-o"></i> Registro Rechazo - Granja Tarapoto
				</h4></center>
			</div>
		</div>
	</div> <br><br>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<table class="table table-bordered table-hover table-full-width" id="sample_1">
				...
				<tbody>
					<?php
						foreach ($rechazo as $value) { ?> <tr>
							<td class="center"><?php echo $value->rec_id?></td>
							<td class="center"><?php echo $value->ani_rp?></td>
							<td class="center"><?php echo $value->car_descripcion?></td>
							<td class="center"><?php echo $value->rec_fecha?></td>
							<td class="center">
								<button class="sb-toggle btn btn-warning btn-xs" onclick="modificar(<?php echo $value->rec_id; ?>)"><i class="fa fa-edit"></i></button>
								<button class="btn btn-danger btn-xs"><i class="fa fa-times" onclick="eliminar(<?php echo $value->rec_id; ?>)"></i></button>
							</td>
						</tr> <?php }
					?>
				</tbody>
				...
				<div class="tab-pane active" id="users">
					<div class="panel panel-default">
						<div class="panel-body">
							<form class="form-horizontal" id="form_rechazo"> <br>
								<input type="hidden" name="id" id="id" class="form-control">
								<input type="hidden" name="evento" value="8">
								<div class="form-group">
									<label class="col-sm-3 control-label">
											Animal
									</label>
									<div class="col-sm-9">
										<?php echo form_dropdown('rec_animal', $animales,'', 'class="form-control" required'); ?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
										Especificacion de Rechazo
									</label>
									<div class="col-sm-9">
