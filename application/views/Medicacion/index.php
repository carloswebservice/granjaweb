	...
	<div class="row">
		<div class="col-sm-12">
			<div class="breadcrumb">
				...
				<center><h4>
					<i class="fa fa-file-text-o"></i> Registro Medicacion - Granja Tarapoto
				</h4></center>
			</div>
		</div>
	</div> <br><br>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<table class="table table-bordered table-hover table-full-width" id="sample_1">
				...
				<tbody>
					<?php
						foreach ($medicacion as $value) { ?> <tr>
							<td class="center"><?php echo $value->mec_id?></td>
							...
							<td class="center"><?php echo $value->mec_fecha?></td>
							<td class="center">
								<button class="sb-toggle btn btn-warning btn-xs" onclick="modificar(<?php echo $value->mec_id; ?>)"><i class="fa fa-edit"></i></button>
								<button class="btn btn-danger btn-xs"><i class="fa fa-times" onclick="eliminar(<?php echo $value->mec_id; ?>)"></i></button>
							</td>
						</tr> <?php }
					?>
				</tbody>
		...
		<div class="sidebar-wrapper">
			<ul class="nav nav-tabs nav-justified" id="sidebar-tab">
				<li class="active" style="font-size:18px;padding:5px;">
					<a href="#users" role="tab" data-toggle="tab"><i class="fa fa-list"></i> Registro Medicacion</a>
				</li>
			</ul>
				...
				<div class="tab-pane active" id="users">
					<div class="panel panel-default">
						<div class="panel-body">
							<form class="form-horizontal" id="form_medicacion"> <br>
								<input type="hidden" name="id" id="id" class="form-control">
								<input type="hidden" name="evento" value="9">
								<div class="form-group">
									<label class="col-sm-3 control-label">
											Animal
									</label>
									<div class="col-sm-9">
										<?php echo form_dropdown('mec_animal', $animales,'', 'class="form-control" required'); ?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
									...
									<div class="col-sm-9">
										<?php echo form_dropdown('mec_medicamentos', $medicamentos,'', 'class="form-control" required'); ?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
									...
									<div class="col-sm-9">
										<?php echo form_dropdown('mec_via_aplicacion', $via_aplicacion,'', 'class="form-control" required'); ?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
