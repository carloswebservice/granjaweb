	...
	<div class="row">
		<div class="col-sm-12">
			<div class="breadcrumb">
				...
				<center><h4>
					<i class="fa fa-file-text-o"></i> Registro Secado - Granja Tarapoto
				</h4></center>
			</div>
		</div>
	</div> <br><br>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<table class="table table-bordered table-hover table-full-width" id="sample_1">
				...
				<tbody>
					<?php
						foreach ($secado as $value) { ?> <tr>
							<td class="center"><?php echo $value->sec_id?></td>
							<td class="center"><?php echo $value->ani_rp?></td>
							<td class="center"><?php echo $value->mdm_descripcion?></td>
							<td class="center"><?php echo $value->sec_fecha?></td>
							<td class="center">
								<button class="sb-toggle btn btn-warning btn-xs" onclick="modificar(<?php echo $value->sec_id; ?>)"><i class="fa fa-edit"></i></button>
								<button class="btn btn-danger btn-xs"><i class="fa fa-times" onclick="eliminar(<?php echo $value->sec_id; ?>)"></i></button>
							</td>
						</tr> <?php }
					?>
				</tbody>
				...
				<div class="tab-pane active" id="users">
					<div class="panel panel-default">
						<div class="panel-body">
							<form class="form-horizontal" id="form_secado"> <br>
								<input type="hidden" name="id" id="id" class="form-control">
								<input type="hidden" name="evento" value="7">
								<div class="form-group">
									<label class="col-sm-3 control-label">
											Animal
									</label>
									<div class="col-sm-9">
										<?php echo form_dropdown('sec_animal', $animales,'', 'class="form-control" required'); ?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
										Medicamentos de Cuartos Mamarios
									</label>
									<div class="col-sm-9">
